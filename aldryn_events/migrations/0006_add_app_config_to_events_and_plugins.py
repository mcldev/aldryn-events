    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('master', models.ForeignKey(on_delete=models.deletion.CASCADE, related_name='translations', editable=False, to='aldryn_events.EventsConfig', null=True)),
            ],
            options={
                'managed': True,
        ...
        migrations.AddField(
            ...
            name='app_config',
            field=models.ForeignKey(on_delete=models.deletion.CASCADE, verbose_name='app_config', to='aldryn_events.EventsConfig', null=True),
