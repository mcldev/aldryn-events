    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=models.deletion.CASCADE, null=True, blank=True, to=settings.AUTH_USER_MODEL, unique=True, verbose_name='user')),
            ],
            options={
            },
            bases=(models.Model,),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('master', models.ForeignKey(on_delete=models.deletion.CASCADE, related_name='translations', editable=False, to='aldryn_events.Event', null=True)),
            ],
            options={
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('event', models.ForeignKey(on_delete=models.deletion.CASCADE, to='aldryn_events.Event')),
            ],
            options={
            },
            bases=(models.Model,),
